        ...
        >
          <div className="card_heading">
            <div className="card_heading_left">
              ...
              {/* <span style={{backgroundColor:"rgba(255, 235, 235, 1)",color:"black",fontSize:"1.2vh", width:"2.5vh", height:"2.5vh", borderRadius:"50%", display:"flex",alignItems:"center",justifyContent:"center"}}>AK</span> */}
            </div>
            <div
